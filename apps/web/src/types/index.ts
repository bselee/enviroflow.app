...
/**
 * Growth stage for a diary cycle
 */
...
/**
 * Status of a diary cycle
 */
export type DiaryCycleStatus = 'active' | 'completed' | 'archived';

/**
 * Diary cycle entity from database
 */
...
/**
 * Diary cycle with room details (for joined queries)
 */
export interface DiaryCycleWithRoom extends DiaryCycle {
  room?: {
    id: string;
    name: string;
  } | null;
...
/**
 * Diary cycle with counts (for list views)
 */
...
/**
 * Input for creating a new diary cycle
 */
...
/**
 * Input for updating a diary cycle
 */
...
/**
 * Sensor snapshot captured at diary entry time
 */
...
/**
 * Diary entry entity from database
 */
export interface DiaryEntry {
  ...
  content: string;
  tags: DiaryEntryTag[];
  sensor_snapshot: SensorSnapshot | null;
  entry_date: string;
  created_at: string;
  updated_at: string;
}
...
/**
 * Diary entry with photos (for detail views)
 */
...
/**
 * Diary photo entity from database
 */
...
/**
 * Input for creating a diary photo
 */
export interface CreateDiaryPhotoInput {
  entry_id: string;
  storage_path: string;
...
/**
 * Response from diary cycles list API
 */
export interface DiaryCyclesListResponse {
  cycles: DiaryCycleWithCounts[];
  count: number;
}

/**
 * Response from diary entries list API
 */
export interface DiaryEntriesListResponse {
